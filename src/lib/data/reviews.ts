...
const reviews: Review[] = [
  ...
  },
  {
    ...
    author: 'Allen Odisho',
    content:
      'Ramsin and Aaron made the home buying process super simple and easy. We closed in less than 2 weeks. 10/10 would recommend',
